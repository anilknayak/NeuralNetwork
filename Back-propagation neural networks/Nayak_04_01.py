...
# Back-propagation Using TensorFlow

import tkinter as tk
import Nayak_04_02 as N04  # This module is for plotting components
...
class WidgetsWindow(tk.Tk):
    def __init__(self):
        ...
        self.display_activation_functions = N04.BackPropagation(self, self.left_frame)
...
def close_window_callback(root):
    if tk.messagebox.askokcancel("Quit", "Do you really wish to quit, Back-propagation Using TensorFlow?"):
        root.destroy()
...
widgets_window.title('Assignment_03 -- Nayak -- Back-propagation Using TensorFlow')
