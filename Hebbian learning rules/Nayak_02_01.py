...
import Nayak_02_02 as k02  # This module is for plotting components

class WidgetsWindow(tk.Tk):
    def __init__(self):
        tk.Tk.__init__(self)
        self.minsize(self.winfo_screenwidth(),self.winfo_screenheight()-200)
        self.rowconfigure(0, weight=1)
        self.columnconfigure(2, weight=1)
        self.menu_bar = None
        self.tool_bar = None
        self.status_bar = StatusBar(self, self,bg='red',bd=1, relief=tk.SUNKEN)
        self.top_frame = StatusBar(self, self, bg='red', bd=1, relief=tk.SUNKEN)

        self.center_frame = tk.Frame(self)

        # Create a frame for plotting graphs
        self.left_frame = PlotsDisplayFrame(self, self.center_frame, bg='white')
        self.display_activation_functions = k02.HebbianLearning(self, self.left_frame)
        ...
        self.top_frame.grid(row=0, column=0, sticky=tk.N + tk.E + tk.S + tk.W)
        self.top_frame.rowconfigure(1)
        ...
        self.status_bar.rowconfigure(1, minsize=20)
...
widgets_window.title('Assignment_02 -- Nayak -- Hebbian Learning')
