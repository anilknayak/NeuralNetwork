...
annotation_path = "/Users/anilnayak/Downloads/VOCdevkit/VOC2012/Annotations"
images_path = "/Users/anilnayak/Downloads/VOCdevkit/VOC2012/JPEGImages"
...
if is_exist_ann and is_exist_img:
    print("Listig the Images and Annotations Available")
    ...
    for annotation_file_path in annotations_paths:
        annotation_file_path = annotation_path + "/" + annotation_file_path
    ...
    for distribution in distributions.keys():
        ...
        for file_dict in files:
            ...
            if training_flag:
                shutil.copy2(annotation_file,"./train/")
                shutil.copy2(image_file, "./train/")
            else:
                shutil.copy2(annotation_file, "./test/")
                shutil.copy2(image_file, "./test/")

            shutil.copy2(annotation_file, "./")
            shutil.copy2(image_file, "./")
